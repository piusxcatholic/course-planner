...
function App() {
  ...
  // Modals
  const [prereqModal,  setPrereqModal]  = useState(null);  // { course, missingPrereqs, missingNames, isAnyOf }
  const [placeModal,   setPlaceModal]   = useState(null);  // { course } – add new
  const [moveModal,    setMoveModal]    = useState(null);  // { course } – move existing
        ...
        <div className="dashboard-top">
          ...
          {dualCredits > 0 && (
            <div className="badge-block badge-dual">
              <div className="badge-label">Dual-Enrollment</div>
